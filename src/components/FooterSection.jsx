...
const FooterSection = () => {
  return (
    <footer className="h-[454px] flex flex-col justify-center items-center gap-4">
      <h2 className="text-purple text-3xl mb-4 font-bold">Send me a message!</h2>
      <p className="text-2xl leading-9 text-center">
        Got a question or proposal, or just want <br/> to say hello? Go ahead.
      </p>
      <a href="mailto:aysen904@gmail.com" className="text-purple text-xl font-medium hover:underline">
        aysen904@gmail.com
      </a>
